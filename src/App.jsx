...
import { Copy, Check, TerminalSquare, Sparkles, Settings2, History, AlertTriangle, Bold, Underline, UserRound, Code2, Trash2, WandSparkles, Gem, Heart } from 'lucide-react';
...
function App() {
  ...
  return (
    <div className="min-h-screen bg-discord-bg text-discord-text p-4 md:p-8 flex flex-col items-center">
      ...
      <footer className="mt-16 pb-8 flex flex-col items-center gap-4">
        <div className="h-px w-24 bg-gradient-to-r from-transparent via-discord-divider to-transparent"></div>
        
        <div className="flex items-center gap-6">
          <a 
            href="https://github.com/franklinarauj" 
            target="_blank" 
            rel="noopener noreferrer"
            className="flex items-center gap-2 text-gray-500 hover:text-white transition-all duration-300 text-sm group"
          >
            <svg 
          ...
          <div className="w-1.5 h-1.5 rounded-full bg-discord-divider"></div>
        ...
        <p className="text-gray-500 text-xs flex items-center gap-1.5">
          Desenvolvido com <Heart className="w-3 h-3 text-red-500 animate-pulse" /> para a comunidade do Discord
        </p>
      </footer>
    </div>
  );
